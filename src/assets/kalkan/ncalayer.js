...
function callNCALayer(callbackM) {
...
function signXml2(storageName, keyType, xmlToSign, callBack) {
  var signXml2 = {
    "module": "kz.gov.pki.knca.commonUtils",
    "method": "signXml",
    "args": [storageName, keyType, xmlToSign, "", ""]
  ...
  callback = callBack;
  webSocket.send(JSON.stringify(signXml2));
}
...
//         }
//       };
//       if (callback != null && rw.code === "200") {
//         window[callback](rw);
//         closeNCALayer();
//       } else if (rw.code === "500") {
//         console.log('CLOSE NCLAYER!!!');
//         unblockScreen();
//         closeNCALayer();
//       }
//     }
...
// function blockScreen() {
//   $.blockUI({
//     message: '<img src="loading.gif" /><br/>Подождите, выполняется операция в NCALayer...',
//     css: {
//       border: 'none',
//       padding: '15px',
//       backgroundColor: '#000',
